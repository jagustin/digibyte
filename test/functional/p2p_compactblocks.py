...
# TestNode: A peer we use to send messages to lekcoind, and store responses.
...
class CompactBlocksTest(LekCoinTestFramework):
    ...
    # This test actually causes lekcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that lekcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for lekcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # lekcoind will not send blocktxn responses for blocks whose height is
