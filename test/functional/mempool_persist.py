...
By default, lekcoind will dump mempool on shutdown and
...
class MempoolPersistTest(LekCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give lekcoind a second to reload the mempool
        ...
        self.log.debug("Prevent lekcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
