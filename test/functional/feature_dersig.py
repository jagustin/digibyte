...
class BIP66Test(LekCoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # lekcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and lekcoind produces more specific reject
            # reasons.
