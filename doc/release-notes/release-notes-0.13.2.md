LekCoin Core version 0.13.2 is now available from:

  <https://lekcoin.org/bin/lekcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update lekcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow lekcoin-tx to create v2 transactions (dgbdrak)
