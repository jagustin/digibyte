LekCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/lekcoin/files/LekCoin/lekcoin-0.5.4/
...
http://gitorious.org/lekcoin/lekcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix LekCoin-Qt notifications under Growl 1.3.
Increase required age of LekCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLekCoin properly when installing LekCoin-Qt over it. (Windows)
