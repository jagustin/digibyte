Download URL: https://sourceforge.net/projects/lekcoin/files/LekCoin/lekcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 LEK fee schedule (users still pay 0.01 LEK per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #lekcoin00 - #lekcoin99
