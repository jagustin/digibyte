LekCoin Core version 0.14.2 is now available from:

  <https://lekcoin.org/bin/lekcoin-core-0.14.2/>
...
(in LekCoin Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in LekCoin-Qt when using coin
...
- #10228 `ae479bc` Regenerate lekcoin-config.h as necessary (theuni)
