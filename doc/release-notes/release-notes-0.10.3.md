LekCoin Core version 0.10.3 is now available from:

  <https://lekcoin.org/bin/lekcoin-core-0.10.3/>
...
(see https://github.com/lekcoin/lekcoin/pull/6793, as well as the 0.11.0
