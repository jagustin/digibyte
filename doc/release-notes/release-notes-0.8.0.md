LekCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/lekcoin/files/LekCoin/lekcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the LekCoin
...
New/changed settings (command-line or lekcoin.conf file)
--------------------------------------------------------
