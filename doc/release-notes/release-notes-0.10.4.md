LekCoin Core version 0.10.4 is now available from:

  <https://lekcoin.org/bin/lekcoin-core-0.10.4/>
...
- #6953 `43c2789` Split lekcoin-tx into its own package
- #6953 `dfe0d4d` Include lekcoin-tx binary on Debian/Ubuntu
