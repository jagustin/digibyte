LekCoin Core version 0.9.4 is now available from:

  https://lekcoin.org/bin/0.9.4/
...
this update is incompatible with the LekCoin system and could lead to consensus
forks.

LekCoin Core released binaries from https://lekcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~lekcoin/+archive/ubuntu/lekcoin
- A third-party or self-compiled LekCoin Core

upgrade to LekCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
