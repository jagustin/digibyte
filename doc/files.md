...
* lekcoin.conf: contains configuration settings for lekcoind or lekcoin-qt
* lekcoind.pid: stores the process id of lekcoind while running
...
* debug.log: contains debug information and general logging generated by lekcoind or lekcoin-qt
