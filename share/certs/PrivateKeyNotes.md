...
unlocked to sign the LekCoin-Qt.app bundle.
...
allowing somebody to distribute a LekCoin-Qt.app or lekcoin-qt-setup.exe with a valid
...
that the lekcoin-qt.exe file inside the installer had not been tampered with.
