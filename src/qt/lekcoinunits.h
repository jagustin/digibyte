...
/** LekCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LekCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LekCoinUnits(QObject *parent);

    /** LekCoin units.
      @note Source: https://en.lekcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        LEK,
...
typedef LekCoinUnits::Unit LekCoinUnit;
