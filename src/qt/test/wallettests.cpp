...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<LekCoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_lekcoin-qt -platform xcb      # Linux
//     src/qt/test/test_lekcoin-qt -platform windows  # Windows
//     src/qt/test/test_lekcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = LekCoinUnits::formatWithUnit(unit, balance, false, LekCoinUnits::separatorAlways);
    ...
    // Amount input
    LekCoinAmountField* amountInput = receiveCoinsDialog.findChild<LekCoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: lekcoin:")) != -1);
