...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, LekCoinUnits::SeparatorStyle separators=LekCoinUnits::separatorStandard) const;
