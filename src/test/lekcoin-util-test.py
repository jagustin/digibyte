...
# Copyright 2016 The LekCoin Core developers
...
help_text="""Test framework for lekcoin utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/lekcoin-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "lekcoin-util-test.json", buildenv)
